...
const F9GameFeel = (() => {
  ...
  // [Oturum 87 — kullanıcı isteği: "kutular ayrı, rakamlar ayrı"] Sayı
  // efektleri (halka/ışın/kıvılcım) fx/number-fx.js'e TAŞINDI —
  // aşağıdaki celebrateMerge() artık F9NumberFx.ripple/lightRays/
  // sparkleBurst çağırıyor, mantık birebir aynı.
